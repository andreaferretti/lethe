...
object LocalPathORAM {
  ...
  def apply[K, V, Id <: K, Doc <: V](remote: Remote, passPhrase: String, emptyID: Id, empty: Doc, L: Int, Z: Int)(implicit picker: Pickler[(K, V)]) =
    new LocalPathORAM(StandardClient[(K, V)](remote, passPhrase), new SecureRandom, emptyID, empty, L, Z)
